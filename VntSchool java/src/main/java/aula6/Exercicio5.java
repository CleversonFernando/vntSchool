...
public class Exercicio5 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 3; i++) {
            System.out.println("Entre com " + i + "º valor:");
        ...
        if ((list.get(0) + list.get(1) > list.get(2)) && (list.get(0) + list.get(2) > list.get(1)) &&
            ...
            if (list.get(0).equals(list.get(1)) && (list.get(1).equals(list.get(2)))) {
                ...
                resposta = ((list.get(0).equals(list.get(1)) || (list.get(1).equals(list.get(2))) ||
                        (list.get(2).equals(list.get(0))))) ? "Triangulo Isóceles" : "Triangulo escaleno";
            }
        } else {
